    ...
    const DB = {
        ...
        plots: [
            ...
            // 3. 灵异惊险与精神污染 (惊险/涩涩)
            {
                ...
                deviation:'处于世界线异变期。贞子的怨念与某种高维魅魔基因融合，诅咒不再只是致死，而是会在七天内让受害者变得愈发帅气/迷人，同时不断榨取受害者的理智与体液，最终将其转化为传播诅咒的欲奴。',
                law:'灵异法则与精神污染受极度强化；常规物理攻击对怨灵完全无效；意志力薄弱者极易在幻觉中沦陷并主动献身。',
                risk:'七天倒计时结束或理智归零，将触发强制「灵体附身」与「榨干恶堕」。',
                ecology:'多方异端潜伏在都市中，围绕“变异录像带”的母带展开争夺。有人试图破解诅咒将其作为精神控制武器，有人则在暗中猎捕那些处于发情诅咒期的男女高中生。你必须在惊悚的灵异追杀与无处不在的肉体诱惑中寻找生机。',
                identity:'灵异事件调查员 / 意外看过录像带的不良少年 / 掌握除灵术的地下法师',
            },
            // 4. 战争绝境与凌辱 (刺激/压迫)
            {
            ...
            // 5. 著名IP与魔术契约 (涩涩/博弈)
            {
                ...
                deviation:'圣杯系统遭到异端篡改，魔力供给规则发生异变。御主与从者之间必须通过高频的“体液交换”与“肉体补魔”才能维持存在，战败的从者将被强行剥夺令咒并沦为胜者的魔力苗床。',
                ...
                identity:'落魄的野生魔术师 / 穗群原学园的普通学生 / 圣堂教会的底层代行者',
            },
            // 6. 赛博朋克与悲剧 (刺激/适合过渡)
            {
            ...
            // 8. 现代怪异与支配 (惊险/刺激)
            {
                ...
                name:'【鬼灭之刃】',
                time:'锁定于【游郭篇前夕】。',
                deviation:'剧情出现香艳与致命的偏离。部分剑士与鬼受到未知血鬼术污染，陷入强制发情与理智崩溃的边缘，轮回者的介入让局势更加混乱。',
                law:'日轮刀与波纹法则；只有蕴含太阳能量的攻击才能彻底杀死鬼；极度渴望鲜血与体液的异变血鬼术正在蔓延，意志不坚者将沦为欲望的奴隶。',
                risk:'若被异变的鬼或陷入疯狂的剑士捕获，将被榨干生命力与精气直至死亡。',
                ecology:'异变血鬼术导致花街沦为情欲与杀戮的温床，轮回者在理智边缘猎杀或收服目标。',
                identity:'鬼杀队的新晋剑士 / 潜伏在花街的神秘浪人 / 刚转化为鬼的异变者',
            }
        ]
    };
